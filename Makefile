...
build:  # builds for the current platform
	go install -ldflags "-X github.com/bdewey/git-stack/src/cmd.version=v0.0.0-test -X github.com/bdewey/git-stack/src/cmd.buildDate=today"
...
cross-compile:  # builds the binary for all platforms
	...
	gox -ldflags "-X github.com/bdewey/git-stack/src/cmd.version=${TRAVIS_TAG} -X github.com/bdewey/git-stack/src/cmd.buildDate=${date}" \
